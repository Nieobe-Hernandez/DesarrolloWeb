      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            ...
            <p className="lead">
              ...
              Nuestra misión es ofrecer soluciones eficientes que mejoren la
              vida de nuestros usuarios.
            </p>
            <p>
              Con años de experiencia en desarrollo de software, nos
              especializamos en crear aplicaciones modernas, seguras y
              escalables. Nuestro compromiso es la excelencia y la satisfacción
              del cliente.
            </p>
          </div>
        </div>
        ...
        <div className="row text-center mt-5">
          ...
          <div className="col-md-4">
            ...
            <h4>Pasión</h4>
            <p>
              Nos encanta lo que hacemos y ponemos el corazón en cada proyecto.
            </p>
          </div>
          <div className="col-md-4">
            <i
        ...
        <div className="text-center mt-5">
          ...
          <p>
            ...
            <strong>dericklagunes@utez.edu.mx</strong>
          </p>
        </div>
      </div>
    </div>
